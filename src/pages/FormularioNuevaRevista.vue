            ...
            <div>
                    ...
                    <div class="d-flex justify-content-center">
                      <div class="w-75 p-3 align-items-center">
                        <div class="form-group d-flow-root">
                          ...
                          <div
                            class="isNecessary text-left small"
                            style="color: red;"
                          >Es necesario llenar este campo</div>
                          <input
                            id="titulo"
                        ...
                        <div class="form-group d-flow-root">
                          ...
                          >Descripción de la revista</label>
                          <textarea
                            id="descripcion"
                            v-model="journal.journalDescription"
                        ...
                        <div class="form-group d-flow-root">
                          <label
                            for="fechaCreacion"
                            class="text-left d-block"
                          >Año de creación de la revista*</label>
                          <div
                            class="isNecessary text-left small"
                            style="color: red;"
                          >Es necesario llenar este campo</div>
                        ...
                        <div class="form-group d-flow-root">
                          <label
                            for="periodicidadId"
                            class="text-left d-block"
                          >Ingrese la periodicidad de su revista*</label>
                          <div
                            class="isNecessary text-left small"
                            style="color: red;"
                          >Es necesario llenar este campo</div>
                          <div class="pl-4">
                            <div
                              ...
                              v-for="p in optionsForm.periodicities"
                              :key="p.id"
                            >
                              <input
                                name="periodicidadId"
                                id="perioricidad-0"
                                v-model="journal.periodicity"
                                type="radio"
                                class="form-check-input"
                                :value="p.id"
                              />
                              <span v-text="p.periodicidad"></span>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="form-group d-flow-root">
                          ...
                          <input
                            id="periodicidadOtro"
                            v-model="journal.otherPerioricity"
                            type="text"
                            class="form-control max-width-35em"
                          />
                        </div>
                      ...
                      <div class="w-75 p-3 align-items-center">
                        ...
                        <div class="form-group d-flow-root">
                          <label
                            for="googlescholar"
                            class="text-left d-block"
                          >Google Scholar Revista</label>
                          <input
                            id="googlescholar"
                            v-model="journal.googleScholarJournal"
                      ...
                      <div class="w-75 p-3 align-items-center">
                        <div class="form-group d-flow-root">
                          ...
                          <div class="pl-4">
                            <div
                              class="d-flex inputOption"
                              v-for="category in optionsForm.optionCategories"
                              :key="category.id"
                            >
                              <input
                                name="categoriaId"
                                id="categorias-0"
                                v-model="journal.categories"
                                type="checkbox"
                                class="form-check-input"
                                :value="category.id"
                              />
                              <span v-text="category.nombre"></span>
                            </div>
                          </div>
                        </div>
                        <div class="form-group d-flow-root">
                          ...
                          <div class="pl-4">
                            <div
                              class="d-flex inputOption"
                              v-for="indexing in optionsForm.indexations"
                              :key="indexing.id"
                            >
                              <input
                                name="indexacionesId"
                                id="indexaciones-0"
                                v-model="journal.indexations"
                                type="checkbox"
                                class="form-check-input"
                                :value="indexing.id"
                              />
                              <span v-text="indexing.indexaciones"></span>
                            </div>
                          </div>
                        </div>
                        <div class="form-group d-flow-root">
                          ...
                          <div class="pl-4">
                            <div
                              class="d-flex inputOption"
                              v-for="optionLanguage in optionsForm.languages"
                              :key="optionLanguage.id"
                            >
                              <input
                                name="idiomaId"
                                id="idioma-0"
                                v-model="journal.language"
                                type="checkbox"
                                class="form-check-input"
                                :value="optionLanguage.id"
                              />
                              <span v-text="optionLanguage.idioma"></span>
                            </div>
                          </div>
                        </div>
                        <div class="form-group d-flow-root">
                          <label
                            for="licenciaId"
                            class="text-left d-block"
                          >Licencia Creative Commons *</label>
                          <div
                            class="isNecessary text-left small"
                            style="color: red;"
                          >Es necesario llenar este campo</div>
                          <div class="pl-4">
                            <div
                              class="d-flex inputOption"
                              v-for="license in optionsForm.licenses"
                              :key="license.id"
                            >
                              <input
                                name="licenciaId"
                                id="0"
                                type="radio"
                                v-model="journal.CreativeCommons"
                                class="form-check-input"
                                :value="license.id"
                              />
                              <span v-text="license.licencia"></span>
                            </div>
                          </div>
                        </div>
                      </div>
                  ...
                  <b-tab title="Adicionales">
                    <div class="d-flex justify-content-center">
                      <div class="w-75 p-3 align-items-center">
                        <div class="form-group d-flow-root">
                          <label
                            for="politicaAutoarchivoId"
                            class="text-left d-block"
                          >Política de Autoarchivo*</label>
                          <div
                            class="isNecessary text-left small"
                            style="color: red;"
                          >Es necesario llenar este campo</div>
                          <div class="pl-4">
                            <div
                              class="d-flex inputOption"
                              v-for="policy in optionsForm.politics"
                              :key="policy.id"
                            >
                              <input
                                ...
                                id="0"
                                type="radio"
                                v-model="journal.filePolicy"
                                class="form-check-input"
                                :value="policy.id"
                              />
                              <span v-text="policy.politicaAutoarchivo"></span>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="form-group d-flow-root">
                          <label
                            for="estiloCitacionId"
                            class="text-left d-block"
                          >Estilo de citación*</label>
                          <div
                            class="isNecessary text-left small"
                            style="color: red;"
                          >Es necesario llenar este campo</div>
                          <div class="pl-4">
                            <div
                              class="d-flex inputOption"
                              v-for="citationStyle in optionsForm.citationStyles"
                              :key="citationStyle.id"
                            >
                              <input
                                name="estiloCitacionId"
                                id="estCita-0"
                                v-model="journal.citationStyle"
                                type="radio"
                                class="form-check-input"
                                :value="citationStyle.id"
                              />
                              <span v-text="citationStyle.estiloCitacion"></span>
                            </div>
                          </div>
                        </div>
                        <div class="form-group d-flow-root">
                        ...
                        <div class="form-group d-flow-root">
                          <label
                            for="tipoRevisionParesId"
                            class="text-left d-block"
                          >Tipo de revisión por pares *</label>
                          <div
                            class="isNecessary text-left small"
                            style="color: red;"
                          >Es necesario llenar este campo</div>
                          <div class="pl-4">
                            <div
                              class="d-flex inputOption"
                              v-for="type in optionsForm.typeReviewPeer"
                              :key="type.id"
                            >
                              <input
                                name="tipoRevisionParesId"
                                id="revision-0"
                                v-model="journal.reviewPeer"
                                type="radio"
                                class="form-check-input"
                                :value="type.id"
                              />
                              <span v-text="type.tipoRevisionPares"></span>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="form-group d-flow-root">
                          <label
                            for="preprint"
                            class="text-left d-block"
                          >Su revista acepta PrePrint?</label>
                          <div
                            class="isNecessary text-left small"
                            style="color: red;"
                          >Es necesario llenar este campo</div>
                        ...
                        <div class="form-group d-flow-root">
                          <label
                            for="videopresentacion"
                            class="text-left d-block"
                          >Video de la revista</label>
                          <input
                            id="videopresentacion"
                            v-model="journal.video"
                    ...
                    <div class="d-flex justify-content-center">
                      <div class="w-75 p-3 align-items-center">
                        ...
                        <div class="form-group d-flow-root">
                          ...
                          >Es necesario llenar este campo</div>
                          <select
                            v-model="journal.firstOrderliness"
                            class="float-left"
                            id="disciplinaId"
                            required="required"
                            style="margin: 0 100vw 0.6em 0em;"
                        ...
                        <div class="form-group d-flow-root">
                          ...
                          <select
                            class="float-left"
                            v-model="journal.secondOrderliness"
                            id="disciplinaId1"
                            style="margin: 0 100vw 0.6em 0em;"
                          >
                            <option
                        ...
                        <div class="form-group d-flow-root">
                          ...
                          <select
                            class="float-left"
                            v-model="journal.thirdOrderliness"
                            id="disciplinaId2"
                            style="margin: 0 100vw 0.6em 0em;"
                          >
                            <option
                        ...
                        <div class="form-group d-flow-root">
                          ...
                          <select
                            class="float-left"
                            v-model="journal.quarterdOrderliness"
                            id="disciplinaId3"
                            style="margin: 0 100vw 0.6em 0em;"
                          >
                            <option
                        ...
                        <div class="form-group d-flow-root">
                          <label
                            for="palabraClaveId"
                            class="text-left d-block"
                          >Ingresa palabras clave de su revista</label>
                          <input
                            id="palabraClaveId"
                            v-model="journal.keywords"
              ...
              <div class="text-center">
                <b-button-group class="mt-2">
                  <b-button @click="tabIndex++">Guardar</b-button>
                </b-button-group>
              </div>
            </div>
          </div>
...
export default {
  ...
  methods: {
    cambiarEstados() {
      this.$store.commit("setCurrentPage", "nueva-revista");
      this.$store.getters.providerService
        .getModel(`Pais/${this.journal.country}/estados`)
        .then(res => {
          this.optionsForm.states = res.data;
          this.optionsForm.cities = [];
          this.journal.state = 0;
        })
        .catch(function(err) {
          console.log(err);
        });
    ...
    cambiarciudades() {
      this.$store.commit("setCurrentPage", "nueva-revista");
      this.$store.getters.providerService
        .getModel(`Estados/${this.journal.state}/ciudades`)
        .then(res => {
 ...
 guideAuthors:this.guideAuthors,
 editorialTeam:this.editorialTeam,
 ethicsCode:this.ethicsCode,
 periodicity:this.periodicity,
 otherPerioricity:this.otherPerioricity,
 reviewPeer:this.reviewPeer,
 categories:this.categories,
 firstOrderliness:this.firstOrderliness,
 secondOrderliness:this.secondOrderliness,
 thirdOrderliness:this.thirdOrderliness,
 quarterdOrderliness:this.quarterdOrderliness,
 language:this.language,
 CreativeCommons:this.CreativeCommons,
 APC:this.APC,
 ...
 urljournal:this.urljournal,
 indexations:this.indexations,
 googleScholarJournal:this.googleScholarJournal,
 ...
 alert('Se ha registrado la revista correctamente')
 _self.$router.push({
 path: '/Login'
 })
 }).catch(function(err){
