...
export default class ProviderService {
  ...
  addJournalInteraction(journalId, interaction) {
    return new Promise((resolve, reject) => {
      axios.post(this.rootAPI + `EstadisticasRevista/${journalId}/addJournalInteraction`, {interaction},{ headers: { "Authorization": this.accessToken }, withCredentials: true }).then(() => {
        resolve()
      })
    })
  }

  addAnnouncementInteraction(announcementId, interaction) {
    return new Promise((resolve, reject) => {
      axios.post(this.rootAPI + `EstadisticasConvocatoria/${announcementId}/addAnnouncementInteraction`, {interaction},{ headers: { "Authorization": this.accessToken }, withCredentials: true }).then(() => {
        resolve()
      })
    })
  }
